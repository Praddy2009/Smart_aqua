...
void handleNewMessages(int numNewMessages)
{
  ...
  for (int i = 0; i < numNewMessages; i++)
  {
    ...
    if (text == "/start")
    {
      String welcome = "Welcome to Smart_Aqua App, " + from_name + ".\n";
      welcome += "This is Smart_Aqua bot.\n\n";
      welcome += "/mon : to switch the motor ON\n";
      welcome += "/moff : to switch the motor OFF\n";
      welcome += "/status : Status of moisture level\n";
